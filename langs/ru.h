...
msgstr("Изменения в v0.16.1 (просим вас ознакомьться с нашим новым сайтом utox.io)")

msgid(CHANGE_LOG_TEXT)
msgstr(
"\n  ВАЖНОЕ ЗАМЕЧАНИЕ ДЛЯ ПОЛЬЗОВАТЕЛЕЙ WINDOWS\n"
"    В данный момент имеется следующая проблема - программа обновления не работает с .exe-файлами.\n"
...
"    Реализованы групповые голосовые звонки.\n"
"    Настройка FPS во время видеовызова.\n"
"  Исправления:\n"
"    Улучшена стабильность под OS X.\n"
"    Снова работает видео под Linux.\n"
"    Исправления и улучшения интерфейса. (Спасибо @redmanmale!)\n"
"    Исправлен заголовок окна предпросмотра видео в Windows. (Спасибо @thorpelawrence!)\n"
"    Исправлена часть сбоев в групповых чатах.\n"
"    Исправлено поведение двойного клика средней клавиши мыши в X11. (Спасибо @dkmoz!)\n"
"    Исправлен переход по ссылкам с Юникод-символами в Windows.\n"
"    При передаче файлов их имена очищаются от запрещенных символов в Windows.\n"
"    Сохраняются настройки подтверждения приема файлов.\n"
"    Звуковые уведомления теперь воспроизводятся только когда закрыто окно программы uTox.\n"
"    Сообщения помечаются прочитанными, если они пришли, когда чат был открыт.\n"
"    Выбор файла GTK теперь работает с OpenBSD и NetBSD.\n"
"    Исправлено поведение переключателя настройки автозапуска.\n"
"    Используется псевдоним контакта при уведомлении о наборе текста.\n"
"    Добавлены метки времени сообщения при экспорте чата.\n"
"  Разработка\n"
"    Прекращена поддержка ToxDNS.\n"
"    Добавлена инструкция по сборке для OS X (Спасибо @publicarray!)\n"
"    Прогон тестов для OS X (в дополнение к Linux).\n"
...
"\n"
"    Знаете другой язык? Прочитайте список изменений на своем языке?\n"
"    Помогите нам перевести uTox!\n"
"\nv0.15.0\n"
"  Исправления:\n"
"    Видео снова работает в Windows.\n"
"    При автоматическом приеме файлов в портативном режиме они сохраняются в ту же папку.\n"
"    Обновлен украинский перевод. (Спасибо v2e!)\n"
...
msgid(REQ_SENT)
msgstr("Запрос на добавление в контакты отправлен. Ваш собеседник появится в сети после того, как заявка будет принята.")
...
msgstr("Где вы хотите сохранить этот файл?")
...
msgstr("ПРЕДУПРЕЖДЕНИЕ: µTox автоматически начнет шифрование с этим паролем.")
...
msgid(PROXY_FORCE)
msgstr("Всегда использовать прокси")

msgid(WARNING)
msgstr("Изменение сетевых настроек приведет к временному отключению от сети Tox")

msgid(SAVE_CHAT_HISTORY)
msgstr("Сохранять историю чата")

msgid(AUDIONOTIFICATIONS)
msgstr("Включить звуковое уведомление")
...
msgid(DPI_060)
msgstr("Пользовательское DPI 60%")

msgid(DPI_070)
msgstr("Пользовательское DPI 70%")

msgid(DPI_080)
msgstr("Пользовательское DPI 80%")

msgid(DPI_090)
msgstr("Пользовательское DPI 90%")

msgid(DPI_100)
msgstr("Пользовательское DPI 100%")

msgid(DPI_110)
msgstr("Пользовательское DPI 110%")

msgid(DPI_120)
msgstr("Пользовательское DPI 120%")

msgid(DPI_130)
msgstr("Пользовательское DPI 130%")

msgid(DPI_140)
msgstr("Пользовательское DPI 140%")

msgid(DPI_150)
msgstr("Пользовательское DPI 150%")

msgid(DPI_160)
msgstr("Пользовательское DPI 160%")

msgid(DPI_170)
msgstr("Пользовательское DPI 170%")

msgid(DPI_180)
msgstr("Пользовательское DPI 180%")

msgid(DPI_190)
msgstr("Пользовательское DPI 190%")

msgid(DPI_200)
msgstr("Пользовательское DPI 200%")

msgid(DPI_210)
msgstr("Пользовательское DPI 210%")

msgid(DPI_220)
msgstr("Пользовательское DPI 220%")

msgid(DPI_230)
msgstr("Пользовательское DPI 230%")

msgid(DPI_240)
msgstr("Пользовательское DPI 240%")

msgid(DPI_250)
msgstr("Пользовательское DPI 250%")

msgid(DPI_260)
msgstr("Пользовательское DPI 260%")

msgid(DPI_270)
msgstr("Пользовательское DPI 270%")

msgid(DPI_280)
msgstr("Пользовательское DPI 280%")

msgid(DPI_290)
msgstr("Пользовательское DPI 290%")

msgid(DPI_300)
msgstr("Пользовательское DPI 300%")
...
msgstr("Аватар слишком большой. Максимальный размер: ")
...
msgid(THEME_CUSTOM)
msgstr("Пользовательская (см. документацию)")
...
msgstr("Изменение антиспама приведет к тому, что ваш старый Tox ID больше не будет работать. uTox не обновляет ваш Tox ID на серверах имен.")
