...
void theme_load(char loadtheme)
{
    ...
    COLOUR_MAIN_QUOTETEXT = 0x008800;
    ...
    COLOUR_DROPDOWN_ACTIVE_BACKGROUND = 0xCCCCFF;
    COLOUR_DROPDOWN_ACTIVE_FOREGROUND = COLOUR_MAIN_FOREGROUND;
    ...
    case THEME_DARK:
        ...
        COLOUR_MAIN_FOREGROUND = 0xdfdfdf;
        COLOUR_MAIN_FOREGROUND_SECONDARY = 0xbbbbbb;
        COLOUR_MAIN_ACTIONTEXT = 0x27a9bc;
        COLOUR_MAIN_URLTEXT = COLOUR_MAIN_ACTIONTEXT;
        COLOUR_MAIN_QUOTETEXT = 0x55b317;
        // Buddy list colours
        ...
        COLOUR_DROPDOWN_ACTIVE_BACKGROUND = 0x228888;
        COLOUR_DROPDOWN_ACTIVE_FOREGROUND = COLOUR_MAIN_FOREGROUND;
    ...
    case THEME_LIGHT:
        ...
        COLOUR_EDGE_ACTIVE = COLOUR_MAIN_URLTEXT;
        COLOUR_EDGE_HOVER = 0x707070;
        COLOUR_DROPDOWN_ACTIVE_BACKGROUND = 0xDDEEFF;
        COLOUR_DROPDOWN_ACTIVE_FOREGROUND = COLOUR_MAIN_FOREGROUND;
        break;
    ...
    case THEME_HIGHCONTRAST:
        // Chat area colours
        COLOUR_MAIN_BACKGROUND = 0xFFFFFF;
        COLOUR_MAIN_FOREGROUND = 0x000001;
        COLOUR_MAIN_FOREGROUND_SECONDARY = COLOUR_MAIN_FOREGROUND;
        COLOUR_MAIN_ACTIONTEXT = 0x000033;
        COLOUR_MAIN_QUOTETEXT = 0x003300;
        COLOUR_MAIN_URLTEXT = COLOUR_MAIN_ACTIONTEXT;
        // Top & bottom 'Menu' colours
        COLOUR_MENU_BACKGROUND = COLOUR_MAIN_BACKGROUND;
        COLOUR_MENU_FOREGROUND = COLOUR_MAIN_FOREGROUND;
        COLOUR_MENU_HOVER = COLOUR_MAIN_BACKGROUND;
        COLOUR_MENU_ACTIVE = COLOUR_MAIN_FOREGROUND;
        COLOUR_MENU_ACTIVE_FOREGROUND = COLOUR_MAIN_BACKGROUND;
        // Buddy list colours
        COLOUR_LIST_BACKGROUND = COLOUR_MAIN_FOREGROUND;
        COLOUR_LIST_HOVER_BACKGROUND = COLOUR_MAIN_FOREGROUND;
        COLOUR_LIST_FOREGROUND = COLOUR_MAIN_BACKGROUND;
        COLOUR_LIST_FOREGROUND_SECONDARY = COLOUR_MAIN_BACKGROUND;
        // Text highlighing
        COLOUR_HIGHLIGHT_BACKGROUND = COLOUR_MAIN_FOREGROUND;
        COLOUR_HIGHLIGHT_FOREGROUND = COLOUR_MAIN_BACKGROUND;
        COLOUR_GROUP_UNUSUAL = COLOUR_MAIN_URLTEXT;
        // Inputs
        COLOUR_EDGE_NORMAL = COLOUR_MAIN_FOREGROUND;
        COLOUR_EDGE_ACTIVE = COLOUR_MAIN_FOREGROUND;
