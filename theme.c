...
#define RGB2BGR(a_ulColor) (a_ulColor & 0xFF000000) | ((a_ulColor & 0xFF0000) >> 16) | (a_ulColor & 0x00FF00) | ((a_ulColor & 0x0000FF) << 16)
    COLOR_MAIN_BACKGROUND = RGB2BGR(COLOR_MAIN_BACKGROUND);
    COLOR_MAIN_TEXT = RGB2BGR(COLOR_MAIN_TEXT);
    COLOR_MAIN_SUBTEXT = RGB2BGR(COLOR_MAIN_SUBTEXT);
    COLOR_MAIN_ACTIONTEXT = RGB2BGR(COLOR_MAIN_ACTIONTEXT);
    COLOR_MAIN_QUOTETEXT = RGB2BGR(COLOR_MAIN_QUOTETEXT);
    COLOR_MAIN_URLTEXT = RGB2BGR(COLOR_MAIN_URLTEXT);
    COLOR_MENU_BACKGROUND = RGB2BGR(COLOR_MENU_BACKGROUND);
    COLOR_MENU_TEXT = RGB2BGR(COLOR_MENU_TEXT);
    COLOR_MENU_HOVER_BACKGROUND = RGB2BGR(COLOR_MENU_HOVER_BACKGROUND);
    COLOR_MENU_ACTIVE_BACKGROUND = RGB2BGR(COLOR_MENU_ACTIVE_BACKGROUND);
    COLOR_MENU_ACTIVE_TEXT = RGB2BGR(COLOR_MENU_ACTIVE_TEXT);
    COLOR_LIST_BACKGROUND = RGB2BGR(COLOR_LIST_BACKGROUND);
    COLOR_LIST_HOVER_BACKGROUND = RGB2BGR(COLOR_LIST_HOVER_BACKGROUND);
    COLOR_LIST_TEXT = RGB2BGR(COLOR_LIST_TEXT);
    COLOR_LIST_SUBTEXT = RGB2BGR(COLOR_LIST_SUBTEXT);
    COLOR_SELECTION_BACKGROUND = RGB2BGR(COLOR_SELECTION_BACKGROUND);
    COLOR_SELECTION_TEXT = RGB2BGR(COLOR_SELECTION_TEXT);
    COLOR_GROUP_UNUSUAL = RGB2BGR(COLOR_GROUP_UNUSUAL);
    COLOR_EDGE_NORMAL = RGB2BGR(COLOR_EDGE_NORMAL);
    COLOR_EDGE_ACTIVE = RGB2BGR(COLOR_EDGE_ACTIVE);
    COLOR_EDGE_HOVER = RGB2BGR(COLOR_EDGE_HOVER);
    COLOR_ACTIVEOPTION_BACKGROUND = RGB2BGR(COLOR_ACTIVEOPTION_BACKGROUND);
    COLOR_ACTIVEOPTION_TEXT = RGB2BGR(COLOR_ACTIVEOPTION_TEXT);
    COLOR_STATUS_ONLINE = RGB2BGR(COLOR_STATUS_ONLINE);
    COLOR_STATUS_AWAY = RGB2BGR(COLOR_STATUS_AWAY);
    COLOR_STATUS_BUSY = RGB2BGR(COLOR_STATUS_BUSY);
    COLOR_BUTTON_SUCCESS_BACKGROUND = RGB2BGR(COLOR_BUTTON_SUCCESS_BACKGROUND);
    COLOR_BUTTON_WARNING_BACKGROUND = RGB2BGR(COLOR_BUTTON_WARNING_BACKGROUND);
    COLOR_BUTTON_DANGER_BACKGROUND = RGB2BGR(COLOR_BUTTON_DANGER_BACKGROUND);
    COLOR_BUTTON_DISABLED_BACKGROUND = RGB2BGR(COLOR_BUTTON_DISABLED_BACKGROUND);
    COLOR_BUTTON_SUCCESS_TEXT = RGB2BGR(COLOR_BUTTON_SUCCESS_TEXT);
    COLOR_BUTTON_WARNING_TEXT = RGB2BGR(COLOR_BUTTON_WARNING_TEXT);
    COLOR_BUTTON_DANGER_TEXT = RGB2BGR(COLOR_BUTTON_DANGER_TEXT);
    COLOR_BUTTON_DISABLED_TEXT = RGB2BGR(COLOR_BUTTON_DISABLED_TEXT);
    COLOR_BUTTON_SUCCESS_HOVER_BACKGROUND = RGB2BGR(COLOR_BUTTON_SUCCESS_HOVER_BACKGROUND);
    COLOR_BUTTON_WARNING_HOVER_BACKGROUND = RGB2BGR(COLOR_BUTTON_WARNING_HOVER_BACKGROUND);
    COLOR_BUTTON_DANGER_HOVER_BACKGROUND = RGB2BGR(COLOR_BUTTON_DANGER_HOVER_BACKGROUND);
    COLOR_BUTTON_DISABLED_HOVER_BACKGROUND = RGB2BGR(COLOR_BUTTON_DISABLED_HOVER_BACKGROUND);
    COLOR_BUTTON_SUCCESS_HOVER_TEXT = RGB2BGR(COLOR_BUTTON_SUCCESS_HOVER_TEXT);
    COLOR_BUTTON_WARNING_HOVER_TEXT = RGB2BGR(COLOR_BUTTON_WARNING_HOVER_TEXT);
    COLOR_BUTTON_DANGER_HOVER_TEXT = RGB2BGR(COLOR_BUTTON_DANGER_HOVER_TEXT);
    COLOR_BUTTON_DISABLED_HOVER_TEXT = RGB2BGR(COLOR_BUTTON_DISABLED_HOVER_TEXT);
#endif
