...
#define BM_LARGE_BUTTON_WIDTH (26 * SCALE)
#define BM_LARGE_BUTTON_HEIGHT (20 * SCALE)

#define BM_SMALL_BUTTON_WIDTH (26 * SCALE)
#define BM_SMALL_BUTTON_HEIGHT (10 * SCALE)

#define BM_HUGE_BUTTON_WIDTH (26 * 3 * DEFAULT_SCALE)
#define BM_HUGE_BUTTON_HEIGHT (20 * 3 * DEFAULT_SCALE)
...
#define _BM_LARGE_BUTTON_ICON_WIDTH 11
#define BM_LARGE_BUTTON_ICON_WIDTH (11 * SCALE)
#define _BM_LARGE_BUTTON_ICON_HEIGHT 10
#define BM_LARGE_BUTTON_ICON_HEIGHT (10 * SCALE)
