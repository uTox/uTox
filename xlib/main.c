...
int COLOUR_MAIN_BACKGROUND_MENU;
int COLOUR_MAIN_BACKGROUND;
...
int main(int argc, char *argv[])
{
    ...
    COLOUR_MAIN_ACTIONTEXT = 0x1111ff;
    COLOUR_MAIN_URLTEXT = 0x1111ff;
    // Top & bottom 'Menu' colours
    COLOUR_MENU_BACKGROUND = 0x1c1c1c;
    COLOUR_MENU_HOVER = 0xff1c1c;
    COLOUR_MENU_ACTIVE = 0x00ff1c;
    // Buddy list colours
    COLOUR_LIST_BACKGROUND = 0x414141;
    ...
    // Inputs
    COLOUR_EDGE_BACKGROUND = COLOUR_MAIN_URLTEXT;
    ...
    COLOUR_MENU_ACTIVE = 0x00ff1c;
    // Buddy list colours
    COLOUR_LIST_BACKGROUND = 0xdddddd;
    COLOUR_LIST_HOVER_BACKGROUND = 0xbbbbbb;
