...
int main(int argc, char *argv[])
{
    ...
    /* Setting colours */
    COLOUR_BACKGROUND      = 0xFFFFFF;
    COLOUR_FOREGROUND      = 0x333333;
    COLOUR_LINK_FOREGROUND = 0x0000AA;
    ...
    COLOUR_LIST_HIGHLIGHT_BACKGROUND = 0x808080;
    
    COLOUR_GROUP_UNUSUAL = COLOUR_LINK_FOREGROUND;
    
    COLOUR_EDGE_BACKGROUND = COLOUR_LIST_HIGHLIGHT_BACKGROUND;
