...
static void settings_ADV(void) {
    ...
    CREATE_BUTTON(show_password_settings, SCALE(140), SCALE(150), BM_SBUTTON_WIDTH, BM_SBUTTON_HEIGHT);
    CREATE_EDIT(profile_password,         SCALE(10),  SCALE(88) + (SCALE(85) * panel_profile_password.disabled), SCALE(-10), SCALE(24));
    CREATE_BUTTON(lock_uTox,              SCALE(10),  SCALE(205), BM_SBUTTON_WIDTH, BM_SBUTTON_HEIGHT);
}
