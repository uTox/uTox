...
void theme_load(char loadtheme) {
    ...
    case THEME_SOLARIZED_DARK:
        ...
        COLOR_BACKGROUND_ALT         = COLOR_PROC(SOLAR_BASE02);
        COLOR_BACKGROUND_AUX         = COLOR_BACKGROUND_ALT;
        COLOR_BACKGROUND_LIST        = COLOR_BACKGROUND_ALT;
        COLOR_BACKGROUND_LIST_HOVER  = COLOR_PROC(SOLAR_BASE01);
        COLOR_BACKGROUND_MENU        = COLOR_PROC(SOLAR_BASE03);
        COLOR_BACKGROUND_MENU_HOVER  = COLOR_PROC(SOLAR_CYAN);
        COLOR_BACKGROUND_MENU_ACTIVE = COLOR_BACKGROUND_ALT;

        COLOR_MAIN_TEXT         = COLOR_PROC(SOLAR_BASE2);
        COLOR_MAIN_CHATTEXT     = COLOR_MAIN_TEXT;
        COLOR_MAIN_SUBTEXT      = COLOR_PROC(SOLAR_BASE1);
        COLOR_MAIN_ACTIONTEXT   = COLOR_PROC(SOLAR_BASE3);
        COLOR_MAIN_QUOTETEXT    = COLOR_MAIN_SUBTEXT;
        COLOR_MAIN_REDTEXT      = COLOR_PROC(SOLAR_RED);
        COLOR_MAIN_URLTEXT      = COLOR_PROC(SOLAR_MAGENTA);
        COLOR_MAIN_HINTTEXT     = COLOR_PROC(SOLAR_VIOLET);
        ...
        COLOR_MENU_TEXT         = COLOR_MAIN_TEXT;
        COLOR_MENU_SUBTEXT      = COLOR_MAIN_SUBTEXT;
        COLOR_MENU_ACTIVE_TEXT  = COLOR_MAIN_TEXT;
        ...
        COLOR_ACTIVEOPTION_BACKGROUND = COLOR_BACKGROUND_LIST_HOVER;
        COLOR_ACTIVEOPTION_TEXT       = COLOR_MAIN_TEXT;
        ...
        COLOR_BUTTON_SUCCESS_BACKGROUND       = COLOR_STATUS_ONLINE;
        COLOR_BUTTON_SUCCESS_TEXT             = COLOR_MAIN_TEXT;
        COLOR_BUTTON_SUCCESS_HOVER_BACKGROUND = COLOR_PROC(SOLAR_CYAN);
        COLOR_BUTTON_SUCCESS_HOVER_TEXT       = COLOR_BACKGROUND_MAIN;
        COLOR_BUTTON_WARNING_BACKGROUND       = COLOR_STATUS_AWAY;
        COLOR_BUTTON_WARNING_TEXT             = COLOR_MAIN_TEXT;
        COLOR_BUTTON_WARNING_HOVER_BACKGROUND = COLOR_PROC(SOLAR_ORANGE);
        COLOR_BUTTON_WARNING_HOVER_TEXT       = COLOR_BACKGROUND_MAIN;
        COLOR_BUTTON_DANGER_BACKGROUND        = COLOR_STATUS_BUSY;
        COLOR_BUTTON_DANGER_TEXT              = COLOR_MAIN_TEXT;
        COLOR_BUTTON_DANGER_HOVER_BACKGROUND  = COLOR_PROC(SOLAR_MAGENTA);
        COLOR_BUTTON_DANGER_HOVER_TEXT        = COLOR_BACKGROUND_MAIN;
        COLOR_BUTTON_DISABLED_BACKGROUND      = COLOR_PROC(SOLAR_BASE00);
        COLOR_BUTTON_DISABLED_TEXT            = COLOR_BACKGROUND_MAIN;
        COLOR_BUTTON_DISABLED_TRANSFER        = COLOR_BACKGROUND_LIST;
        COLOR_BUTTON_INPROGRESS_BACKGROUND    = COLOR_PROC(SOLAR_VIOLET);
        COLOR_BUTTON_INPROGRESS_TEXT          = COLOR_BACKGROUND_MAIN;

        COLOR_BUTTON_DISABLED_FOREGROUND      = COLOR_PROC(SOLAR_ORANGE);
        COLOR_BUTTON_INPROGRESS_FOREGROUND    = COLOR_PROC(SOLAR_MAGENTA);
        break;

    case THEME_SOLARIZED_LIGHT:
        COLOR_BACKGROUND_MAIN        = COLOR_PROC(SOLAR_BASE3);
        COLOR_BACKGROUND_ALT         = COLOR_PROC(SOLAR_BASE2);
        COLOR_BACKGROUND_AUX         = COLOR_BACKGROUND_ALT;
        COLOR_BACKGROUND_LIST        = COLOR_BACKGROUND_ALT;
        COLOR_BACKGROUND_LIST_HOVER  = COLOR_PROC(SOLAR_BASE1);
        COLOR_BACKGROUND_MENU        = COLOR_BACKGROUND_ALT;
        COLOR_BACKGROUND_MENU_HOVER  = COLOR_PROC(SOLAR_CYAN);
        COLOR_BACKGROUND_MENU_ACTIVE = COLOR_BACKGROUND_ALT;

        COLOR_MAIN_TEXT         = COLOR_PROC(SOLAR_BASE02);
        COLOR_MAIN_CHATTEXT     = COLOR_MAIN_TEXT;
        COLOR_MAIN_SUBTEXT      = COLOR_PROC(SOLAR_BASE01);
        COLOR_MAIN_ACTIONTEXT   = COLOR_PROC(SOLAR_BASE03);
        COLOR_MAIN_QUOTETEXT    = COLOR_MAIN_SUBTEXT;
        COLOR_MAIN_REDTEXT      = COLOR_PROC(SOLAR_RED);
        COLOR_MAIN_URLTEXT      = COLOR_PROC(SOLAR_MAGENTA);
        COLOR_MAIN_HINTTEXT     = COLOR_PROC(SOLAR_VIOLET);
        ...
        COLOR_BUTTON_DANGER_HOVER_BACKGROUND  = COLOR_PROC(SOLAR_MAGENTA);
        COLOR_BUTTON_DANGER_HOVER_TEXT        = COLOR_BACKGROUND_MAIN;
        COLOR_BUTTON_DISABLED_BACKGROUND      = COLOR_PROC(SOLAR_BASE0);
        COLOR_BUTTON_DISABLED_TEXT            = COLOR_BACKGROUND_MAIN;
        COLOR_BUTTON_DISABLED_TRANSFER        = COLOR_BACKGROUND_LIST;
        COLOR_BUTTON_INPROGRESS_BACKGROUND    = COLOR_PROC(SOLAR_VIOLET);
        COLOR_BUTTON_INPROGRESS_TEXT          = COLOR_BACKGROUND_MAIN;
