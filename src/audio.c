...
static ALuint ringtone, preview;
...
static void utox_audio_init_in(void) {
...
static void utox_audio_init_out(void) {
...
static void utox_audio_init_source(ALuint *source) {
    ALint error;
    alGetError();
...
static void utox_audio_term_source(ALuint *source) {
